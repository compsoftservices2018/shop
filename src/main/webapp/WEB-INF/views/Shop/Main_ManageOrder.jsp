		...
		<div class="form-row m-0 p-1">
			<div class="pr-1">
				...
				<form:input path="order_date" id="order_date" name="order_date"
					type="text" class="form-control form-control-sm formatdatecalendar"
					value="${order_date}" />
			</div>
			<div class="pr-1">
			...
			<div class="pr-1">
				...
				<form:select path="status" type="text" class="form-control form-control-sm">
		...
		<div class="overflow-auto">
			<table class="table table-striped" id="orders" style="width: 100%;">
				...
				<tbody>
					...
					<tr>
						<td>
							<form id="OrderDetail" class="p-0 text-center" method="get" action="OrderDetail">
